...
def reconhecer_objetos(img):
    ...
    cv2.putText(result_image, "Objects: " + str(count_up2000), (10, 470), cv2.FONT_HERSHEY_COMPLEX, 0.7, (255, 0, 0), 2)

    return result_image, roi_images
...
def processar_imagem():
    try:
        ...
        imagem_processada, roi_images = reconhecer_objetos(imagem_array_original)
